...
export default function EditTaskControls(props: EditTaskControlsProps): JSX.Element {
    ...
    return (
        <>
            <input
                ...
                onChange={(event) => { props.setInputToEditTask(event.target.value) }}
            >
            </input>
            <button
                onClick={props.handleSubmitEditTask}
            >
                Submit Edit
            </button>
        </>
